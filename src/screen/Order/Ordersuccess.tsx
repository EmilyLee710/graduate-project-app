    ...
    render() {
        return (
            <View style={{ backgroundColor: 'white', height: 700 }}>
                ...
                <Text style={{ color: 'black', fontSize: 18,textAlign:'center' }}>总金额：{this.props.navigation.state.params.price / 100}</Text>
                ...
                <View style={{ marginTop: 20, flexDirection: 'row', justifyContent: 'center' }}>
                    <TouchableOpacity activeOpacity={0.5} onPress={() => this.props.navigation.navigate('FoodList')}>
                        <View style={{ width: 100, height: 46, backgroundColor: '#d81e06',borderRadius:10 }}>
